...
export function PlacementHero() {
  ...
  const scrollToFeatures = () => {
    const featuresSection = document.getElementById("placement-features");
    if (featuresSection) {
    ...
    <>
      <div className="relative w-full overflow-hidden bg-white dark:bg-black flex flex-col items-center justify-center px-4 md:px-8 min-h-screen md:-mt-2 -mt-4">
        ...
        <div className="absolute top-0 left-0 w-full bg-gray-100/[0.9] dark:bg-[#18181B] text-black dark:text-white text-xs md:text-sm font-normal py-2 md:py-3 text-center z-30">
          ...
          >
            🎓 Transform Your Placement Cell with AI-Driven Automation.{" "}
            <span className="underline">Contact Us</span> to get started
          </a>
        </div>
        ...
        >
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-medium text-black dark:text-white max-w-5xl">
            Transform Your Placement Cell with{" "}
          ...
          <p className="text-lg md:text-xl lg:text-2xl text-gray-600 dark:text-gray-400 max-w-3xl">
            A complete placement automation and career intelligence platform built for modern educational institutions
          </p>
          ...
          <div className="max-w-7xl mx-auto flex flex-col items-center gap-12 md:gap-16">
            <div className="w-full flex flex-col items-center gap-6 md:gap-8">
              ...
              <div className="text-center">
                <div className="text-4xl md:text-6xl font-bold text-brand-500 dark:text-accent-500">
                  40M+
                </div>
                <p className="text-gray-600 dark:text-gray-400 mt-2">Students Across 50,000+ Colleges</p>
              </div>
            </div>
          </div>
        </div>

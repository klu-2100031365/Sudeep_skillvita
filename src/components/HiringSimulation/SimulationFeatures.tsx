...
const simulationFeatures: BentoFeature[] = [
  {
    id: "feature-0",
    title: "Role-Aligned Tracks",
    description: "Simulations built for Software, Product, Design, Marketing, and Operations roles—mirroring real job responsibilities.",
  ...
  },
  {
    ...
    description: "Each deliverable reviewed for clarity, execution, and impact by experienced mentors with detailed feedback.",
    content: <div className="mt-6" />,
  ...
  },
  {
    ...
    description: "Performance scores, insights, and progression data—complete visibility into strengths, weaknesses, and growth.",
    content: <div className="mt-6" />,
  ...
  {
    id: "feature-3",
    title: "Verified Portfolio Proof",
    description: "All work consolidated into verified SkillVita portfolios with direct access to deliverables and performance data.",
    content: <div className="mt-6" />,
...
export function SimulationFeatures() {
  return (
    <section id="simulation-features" className="py-20 md:py-32 px-4 relative overflow-hidden">
      {/* Background */}
        ...
        <div className="text-center mb-12 space-y-4">
          ...
          <h2 className="text-3xl md:text-5xl font-bold">
            <span className="bg-gradient-to-r from-brand-600 to-accent-600 dark:from-brand-400 dark:to-accent-400 bg-clip-text text-transparent">
              SkillVita Simulation Framework
            </span>
          </h2>
          
          <p className="text-base md:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            From structured task execution to verified portfolios—ensuring every candidate is evaluated on real capability
          </p>
        </div>

        {/* Bento Grid */}
        <BentoGridWithFeatures features={simulationFeatures} />
      </div>
    </section>
  );
}

...
export default function Hero({
  ...
  return (
    ...
    >
      <div
        className="absolute -z-10 inset-0 opacity-20 h-[800px] w-full bg-[linear-gradient(to_right,#32fe6b_1px,transparent_1px),linear-gradient(to_bottom,#32fe6b_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_110%)]"
      />
      <div
        className="absolute left-1/2 top-[calc(100%-120px)] lg:top-[calc(100%-200px)] h-[500px] w-[700px] md:h-[500px] md:w-[1100px] lg:h-[750px] lg:w-[140%] -translate-x-1/2 rounded-[100%] border-green-500 bg-black bg-[radial-gradient(closest-side,#000_82%,#32fe6b)] opacity-60"
      />
      ...
      {ctaLabel && (
        <div className="flex justify-center relative z-30 mt-6">
          <Button asChild className="w-fit md:w-52 tracking-tight text-lg py-6 rounded-xl shadow-[0_0_30px_-5px_rgba(50,254,107,0.6)] hover:shadow-green-500/60 hover:scale-105 transition-all duration-300 bg-green-600 hover:bg-green-500 text-white border-0">

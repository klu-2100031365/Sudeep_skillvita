  ...
  return (
    <section className="py-16 bg-white dark:bg-black relative">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <div className="px-8 py-2.5 bg-black dark:bg-white text-white dark:text-black text-base font-medium rounded-full shadow-lg">
            Hire Now
          </div>
        </div>
      )}
      <h2 className="text-2xl font-bold mb-8">
        ...
        <span className="text-brand-500 dark:text-accent-500">Winners</span>
      </h2>
        ...
        {winners.map((winner, index) => (
          ...
          >
            <div className="flex flex-col items-start">
              <div 
                className={`w-20 h-20 rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center text-3xl ring-2 ring-accent-500 ${
              ...
              <h3 className="text-xs font-semibold text-black dark:text-white text-left mt-2">
                {winner.name}
              </h3>
            </div>
          </div>
